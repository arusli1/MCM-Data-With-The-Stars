...
## Results
*   **Success Score**: Achieving a Spearman correlation of 0.736 (RF) and 0.709 (XGB), models identified **Early Judge Mean**, **Early Fan Share**, and **Week 1 Fan Score** as the top predictors. 
*   **Ranking Accuracy**: The Random Forest model correctly predicted the **winner (Top-1) in 58.8% of seasons** and placed the actual winner in the **Top-3 in 91.2% of seasons**, on average only ~1.9 spots off the actual placement.
