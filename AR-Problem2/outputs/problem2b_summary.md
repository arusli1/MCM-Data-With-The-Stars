...
- **For 8 of 21** controversial contestants, **yes**: their placement (and elim week) would be the same under rank as under percent (holding judge_save vs fan_decide fixed).
- For the other **13**, **no**: their outcome would differ under rank vs percent.
- **8** of 21 had the **same outcome in all 4** regimes (placement and elim week identical across rank/percent and judge_save/fan_decide).

## 2. How would including judge-save (judges choose which of bottom two to eliminate) impact the results for this contestant?

- **For 0 of 21** controversial contestants, **judge-save vs fan-decide would have changed that contestant's outcome**: under rank and/or under percent, their placement or elimination week differs when the bottom-two tie-break is judge vs fan.
- For the other **21**, judge-save vs fan-decide would **not** have changed their outcome (same placement and elim week under judge_save and fan_decide).
...
- **Sensitivity** (mean placement range across 4 regimes): fan_favored 1.92, judge_favored 0.88. Higher = more sensitive to which regime is used.
